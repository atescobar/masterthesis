...
def integrate(F,x,y,xStop,h,tol=1.0e-2):
    ...
    for i in range(1000):
        k1 = F(x + a1*h, y + b10*k0)
        k2 = F(x + a2*h, y + b20*k0 + b21*k1)
        k3 = F(x + a3*h, y + b30*k0 + b31*k1 + b32*k2)
        k4 = F(x + a4*h, y + b40*k0 + b41*k1 + b42*k2 + b43*k3)
        k5 = F(x + a5*h, y + b50*k0 + b51*k1 + b52*k2 + b53*k3 + b54*k4)
        k6 = F(x + a6*h, y + b60*k0 + b62*k2 + b63*k3 + b64*k4 + b65*k5)
